...
CF_HOST = env_first("CLOUDFLARE_PUBLIC_HOSTNAME", "CF_PUBLIC_HOSTNAME").lower().rstrip(".")
...
if CF_ENABLED:
    ...
    if not CF_PATH.startswith("/"): raise SystemExit("FATAL: Cloudflare XHTTP path must start with /")
